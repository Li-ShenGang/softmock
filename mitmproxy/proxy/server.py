...
class ConnectionHandler:
        ...
        try:
            ...
            if isinstance(e, exceptions.ClientHandshakeException):
                self.log(
                    ...
                    "The client may not trust the proxy's certificate for {}.".format(
                        e.server),
                    "warn"
                )
                ...
                self.log(str(e), "warn")
                self.log(
                    "Invalid certificate, closing connection. Pass --ssl-insecure to disable validation.", "warn")
            else:
                self.log(str(e), "warn")
            ...
            print(
                "Please lodge a bug report at: https://github.com/mitmproxy/mitmproxy", file=sys.stderr)
    ...
    def log(self, msg, level):
        msg = "{}: {}".format(human.format_address(
            self.client_conn.address), msg)
