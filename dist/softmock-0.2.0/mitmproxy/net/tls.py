...
def _create_ssl_context(
        ...
        alpn_select=None,
        alpn_select_callback: typing.Callable[[
            typing.Any, typing.Any], bytes] = None,
        ...
        if is_cert_verified and depth == 0 and not sni:
            ...
            conn.cert_error = exceptions.InvalidCertificateException(
                "Certificate verification error for {}: {} (errno: {}, depth: {})".format(
                    sni,
                    SSL._ffi.string(
                        SSL._lib.X509_verify_cert_error_string(errno)).decode(),
                    errno,
                    depth
                )
            )
...
def create_server_context(
        ...
        key: SSL.PKey,
        handle_sni: typing.Optional[typing.Callable[[
            SSL.Connection], None]] = None,
...
def get_client_hello(rfile):
    ...
    while len(client_hello) < client_hello_size:
        ...
        offset += record_size
        client_hello_size = struct.unpack(
            "!I", b'\x00' + client_hello[1:4])[0] + 4
    return client_hello
...
class ClientHello:
    ...
    def from_file(cls, client_conn) -> "ClientHello":
        ...
        try:
            ...
            raw_client_hello = get_client_hello(client_conn)[4:]
